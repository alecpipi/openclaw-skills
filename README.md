...
# 或者从源码安装
git clone https://github.com/alecpipi/openclaw-skills.git
cd openscaw
pip install -e .
```
...
- 🪟 **Windows 兼容** — 修复 GBK 编码导致控制台崩溃的问题
- 🔍 **日志扫描增强** — 新增 LogDiscoverer，自动发现和分析日志文件
- 🧠 **深度诊断升级** — 更强根因分析，支持多种异常模式识别
- 🔧 **修复策略完善** — 新增网络重置、进程重启等修复策略
- 📊 **监控优化** — 改进健康评估逻辑，支持进程/上下文/API 多维度检测
- ✅ **测试覆盖** — 25 个单元测试全部通过
